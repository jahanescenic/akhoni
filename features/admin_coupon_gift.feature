Feature:
  As a collector, I want to filter an coupon with coupon code and check gift and redeemed field

  Scenario Outline: ORDER_FIELD_CHECK(gift,redeemed)
   ...
   Then i click on "Success Transaction" and store the code
    ...
    And I want to search with the coupon code and check the gift and redeemed field in coupon
