Feature:
  As a collector, I want to filter an coupon with specific code and check some respective fields

  Scenario Outline: COUPON_FIELD_CHECK(Qty,Value,paid_amount)
    ...
    And I want to search with the coupon code and check the respective fields of coupon



  Examples:
    | url                     | name               |  secret   |
    | http://alpha.akhoni.com/dhaka/set-menu-at-the-8_single-deal-3|  admin_user@akhoni.com | secret |
