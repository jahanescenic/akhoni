Feature:
  As a collector, I want to filter an payment with specific code and check some respective fields

  Scenario Outline: PAYMENT_FIELD_CHECK(Qty,Value,paid_amount)
    ...
    And I want to search with the coupon code and check the respective fields of payment
